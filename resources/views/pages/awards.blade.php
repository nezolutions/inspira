<div class="flex flex-col items-center justify-center w-full py-20 min-h-screen bg-gray-50">
			...
			<div class="grid md:grid-cols-3 gap-6">
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						...
						<p class="text-lg font-semibold text-gray-800">{{ $a1->online_fee }} {{ $a1->on_fee_type }}</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">{{ $a1->offline_fee }} {{ $a1->off_fee_type }}</p>
					</div>
				</div>
			</div>
		@empty
			<div class="grid md:grid-cols-3 gap-6">
				...
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">2.000.000 IDR</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">4.000.000 IDR</p>
					</div>
				</div>
				...
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">1.250.000 IDR</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">2.500.000 IDR</p>
					</div>
				</div>
				...
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">1.000.000 IDR</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">2.000.000 IDR</p>
					</div>
				</div>
	...
	<div class="space-y-8">
		...
		@forelse ($awards->where('category', 'College Students') as $a2)
			<div class="grid md:grid-cols-2 gap-6">
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">{{ $a2->online_fee }} {{ $a2->on_fee_type }}</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">{{ $a2->offline_fee }} {{ $a2->off_fee_type }}</p>
					</div>
				</div>
			</div>
		@empty
		...
		@forelse ($awards->where('category', 'Highschool Students') as $a3)
			<div class="grid md:grid-cols-2 gap-6">
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">{{ $a3->online_fee }} {{ $a3->on_fee_type }}</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">{{ $a3->offline_fee }} {{ $a3->off_fee_type }}</p>
					</div>
				</div>
			</div>
		@empty
			<div class="grid md:grid-cols-2 gap-6">
				...
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">500.000 IDR</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">1.000.000 IDR</p>
					</div>
				</div>
				...
				<div class="border rounded-2xl shadow-lg p-6 flex flex-col">
					...
					<div class="mt-4 border-t pt-4">
						<p class="text-xs text-gray-500">Oral Presentation (Online)</p>
						<p class="text-lg font-semibold text-gray-800">250.000 IDR</p>
						<p class="text-xs text-gray-500 mt-2">Poster Presentation (Offline)</p>
						<p class="text-lg font-semibold text-gray-800">500.000 IDR</p>
					</div>
				</div>
