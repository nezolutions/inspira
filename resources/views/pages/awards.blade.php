    ...
    <div class="space-y-8 w-full max-w-7xl px-6">
        ...
        <div class="flex flex-col pb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 items-stretch gap-6 text-center">
                <div class="flex flex-col items-center justify-center w-full bg-red-600 p-6 rounded-xl shadow-xl h-80 lg:h-96 space-y-4 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="flex flex-col items-center justify-center w-full bg-gray-700 p-6 rounded-xl shadow-xl h-80 lg:h-96 space-y-4 transform hover:scale-105 transition-all duration-300">
                    <div class="bg-white/20 rounded-full p-4 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-white">
        ...
        <div class="flex flex-col pb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-stretch gap-6 text-center">
                <div class="flex flex-col items-center justify-center w-full bg-red-600 p-6 rounded-xl shadow-xl h-80 lg:h-72 space-y-4 transform hover:scale-105 transition-all duration-300">
                    <div class="bg-white/20 rounded-full p-4 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-white">
                ...
                <div class="flex flex-col items-center justify-center w-full bg-gray-700 p-6 rounded-xl shadow-xl h-80 lg:h-72 space-y-4 transform hover:scale-105 transition-all duration-300">
                    <div class="bg-white/20 rounded-full p-4 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-white">
