<div class="relative w-full min-h-screen bg-gray-800 bg-cover bg-no-repeat bg-center bg-fixed"
    style="background-image: url('{{ $home->background ?? asset('images/home.png') }}');">
    ...
    <div class="relative z-20 w-full min-h-screen flex flex-col items-center justify-center">
        <div class="w-full max-w-7xl grid grid-cols-1 xl:grid-cols-2 items-center gap-8 px-6">
            <div class="flex flex-col gap-4 text-center xl:text-start">
                ...
                <p class="text-lg xl:text-2xl text-gray-200 font-medium leading-relaxed">
                    {!! $home->title ?? 'International Forum on Innovation, Strategy, and Presentation of Research Activity' !!}
                </p>
                <blockquote class="relative pl-4 border-l-4 border-red-500 text-base xl:text-lg text-start text-gray-300 italic">
        ...
        @auth
            <div class="mt-10 flex justify-center">
                <a href="{{ url('e/home')}}" class="flex items-center gap-2 text-white bg-gray-700 hover:bg-gray-800 transition px-5 py-3 rounded-xl shadow-md text-base xl:text-lg">
