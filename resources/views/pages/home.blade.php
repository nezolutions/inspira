    ...
    <div class="relative z-20 w-full min-h-screen flex flex-col items-center justify-center px-6">
        ...
        @auth
            <div class="mt-10 flex justify-center">
                <a href="{{ url('e/home')}}" class="flex items-center gap-2 text-white bg-gray-700 hover:bg-gray-800 transition px-5 py-3 rounded-xl shadow-md text-base lg:text-lg">
