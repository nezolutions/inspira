<div class="flex flex-col items-center justify-center w-full py-16 lg:py-0 min-h-screen bg-gray-50">
    <div class="space-y-3 w-full max-w-7xl">
        ...
        <div class="flex flex-col items-center mx-6">
            <p class="text-gray-700 text-lg leading-6 lg:leading-7 lg:text-xl max-w-5xl mx-auto text-justify lg:text-center">
                    ...
                    <table class="min-w-full bg-white text-gray-700">
                        <thead>
                            <tr class="bg-red-600 text-white">
                                <th class="py-3 px-6 text-left text-2xl font-semibold">Agenda</th>
                                <th class="py-3 px-6 text-left text-2xl font-semibold">Timeline</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-white">
                                <td class="py-4 px-6 text-lg">Submission & Payment</td>
                                <td class="py-4 px-6 text-lg">Now - October 10<sup>th</sup> 2025</td>
                            </tr>
                            <tr class="bg-red-50">
                                <td class="py-4 px-6 text-lg">Poster Upload Dateline</td>
                                <td class="py-4 px-6 text-lg">October 10<sup>th</sup> 2025</td>
                            </tr>
                            <tr class="bg-white">
                                <td class="py-4 px-6 text-lg">Presentation (Online)</td>
                                <td class="py-4 px-6 text-lg">October 10-15<sup>th</sup> 2025</td>
                            </tr>
                            <tr class="bg-red-50">
                                <td class="py-4 px-6 text-lg">Presentation (Offline)</td>
                                <td class="py-4 px-6 text-lg">October 21<sup>st</sup> 2025</td>
                            </tr>
                            <tr class="bg-white">
                                <td class="py-4 px-6 text-lg">Announcement & Awards</td>
                                <td class="py-4 px-6 text-lg">October 22<sup>nd</sup> 2025</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
