<div class="flex flex-col items-center justify-center w-full py-20 min-h-screen bg-gray-100">
    <div class="space-y-10 w-full max-w-7xl px-6">
        ...
        <div class="flex flex-col items-center">
            <p class="text-gray-600 text-base xl:text-lg max-w-5xl text-center">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @empty    
                                ...
                                <tr class="bg-red-50 hover:bg-red-100 transition">
                                    <td class="py-4 px-6 text-sm xl:text-lg font-medium">PowerPoint File and Poster Upload Dateline</td>
                                    <td class="py-4 px-6 text-sm xl:text-lg">October 10<sup>th</sup> 2025</td>
                                </tr>
                                <tr class="bg-red-white hover:bg-red-100 transition">
                                    <td class="py-4 px-6 text-sm xl:text-lg font-medium">Oral Presentation Competition (Online)</td>
    ...
    @auth
        <div class="mt-10 flex justify-center">
            <a href="{{ url('e/agenda')}}" class="flex items-center gap-2 text-white bg-gray-800 hover:bg-black transition px-5 py-3 rounded-xl shadow-md text-base xl:text-lg">
