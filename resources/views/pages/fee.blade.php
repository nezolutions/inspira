<div class="flex flex-col items-center justify-center w-full min-h-screen py-16 lg:py-0 bg-gray-50">
    <div class="space-y-3 w-full max-w-7xl">
        <div class="flex flex-col items-center justify-center mb-6">
            <h2 class="text-3xl lg:text-4xl font-bold mb-2">Entry Fee</h2>
                    ...
                    <table class="min-w-full bg-white text-gray-700">
                        <thead>
                            <tr class="bg-red-600 text-white">
                                <th class="py-3 px-6 text-left text-lg lg:text-xl font-semibold">Participant</th>
                                <th class="py-3 px-6 text-left text-lg lg:text-xl font-semibold">Oral Presentation (Online)</th>
                                <th class="py-3 px-6 text-left text-lg lg:text-xl font-semibold">Poster Presentation (Offline)</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($fee as $fees)
                                <tr class="{{ $fees->id % 2 === 0 ? 'bg-red-50' : 'bg-white' }}">
    ...
    @if (auth()->check())
        <div class="relative top-10 w-fit z-10 text-lg">
            <a href="{{ url('e/fee') }}" class="flex items-center text-white bg-gray-700 rounded-full border hover:bg-gray-800 border-gray-600 px-4 py-2 transition">
