        ...
        <form class="max-w-md w-3/4 mx-auto" method="POST" action="{{ url('u/app') }}" enctype="multipart/form-data">
            ...
            <div class="flex-1 items-center gap-2">
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="app_name" id="app_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " value="{{ old('app_name', $app->app_name) }}" required />
