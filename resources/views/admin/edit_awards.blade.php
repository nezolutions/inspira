                ...
                @if(isset($researchers) && count($researchers) > 0)
                    @foreach ($researchers as $index => $award)   
                        <div class="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700 mb-5 researcher-item">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <textarea name="researchers[{{ $index }}][icon]" id="researcher-icon-{{ $index }}" rows="4" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " required>{{ $award->icon }}</textarea>
                ...
                @if(isset($collegeStudents) && count($collegeStudents) > 0)
                    @foreach ($collegeStudents as $index => $award)   
                        <div class="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700 mb-5 college-student-item">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <textarea name="collegeStudents[{{ $index }}][icon]" id="college-icon-{{ $index }}" rows="4" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " required>{{ $award->icon }}</textarea>
                                <label for="college-icon-{{ $index }}" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start:0 rtl:peer-focus:translate-x-1/4 peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Icon (SVG)</label>
                            </div>
                            @if($index > 0)
                ...
                @if(isset($highSchoolStudents) && count($highSchoolStudents) > 0)
                    @foreach ($highSchoolStudents as $index => $award)   
                        <div class="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700 mb-5 high-school-student-item">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <textarea name="highSchoolStudents[{{ $index }}][icon]" id="high-school-icon-{{ $index }}" rows="4" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " required>{{ $award->icon }}</textarea>
                                <label for="high-school-icon-{{ $index }}" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start:0 rtl:peer-focus:translate-x-1/4 peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Icon (SVG)</label>
                            </div>
                            @if($index > 0)
