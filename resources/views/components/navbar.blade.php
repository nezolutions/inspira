...
<div class="fixed lg:hidden bottom-0 left-0 z-50 w-full h-16 bg-gray-700 border-t-2 border-gray-600 select-none">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        ...
        <a href="https://docs.google.com/forms/d/e/1FAIpQLScu_P8sgARBq5Apvboqu9yqBMFHLTYgI_jSWtdVrMeVyNSD5w/viewform" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-800 group transition">
